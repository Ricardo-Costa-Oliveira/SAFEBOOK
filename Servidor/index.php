        ...
        <div class="row row-offcanvas row-offcanvas-left">
            ...
            <div class="column col-sm-10 col-xs-11" id="main">
		      ...
		      -->
				...
				*/
				//$database->insertUserDatabase("TESTETESTETSTETSTETS", "TESTETESTETSTETSTETS");
				$encryption_key = bin2hex(openssl_random_pseudo_bytes(12,$cstrong));
				//$database->insertMessage("1", "1", $encryption_key);

				/* Obter mensagens como ainda nao tenho o login feito
				  e possivel ler as mensagens de toda a gente */
				$database->getMessages();
				//$database->setMessagePublic(1);
